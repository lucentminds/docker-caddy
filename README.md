...
Check [lucentminds/caddy:builder](https://github.com/lucentminds/docker-caddy/blob/master/BUILDER.md) for generating cross-platform Caddy binaries.
...
```sh
$ docker run -d -p 2015:2015 lucentminds/caddy
```
...
```sh
$ docker run -d -p 2015:2015 lucentminds/caddy:php
```
...
```sh
$ docker run -d -v /path/to/php/src:/srv -p 2015:2015 lucentminds/caddy:php
```
Point your browser to `http://127.0.0.1:2015`.
...
```sh
$ docker run -d -v $(pwd)/Caddyfile:/etc/Caddyfile -p 2015:2015 lucentminds/caddy
```
Point your browser to `http://127.0.0.1:2015`.
...
docker build --build-arg \
    ...
    github.com/lucentminds/docker-caddy.git
```
